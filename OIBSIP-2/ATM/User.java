...
public class User 
{
    ...
    public boolean withdraw(double amount) 
    {
        ...
        else 
        {
            ...
            String transaction = "WITHDRAWAL AMMOUNT : -$" + amount + " CURRENT BALANCE : $" + accountBalance;
    ...
    {
        accountBalance += amount;
        String transaction = "DEPOSITED AMMOUNT : +$" + amount + " CURRENT BALANCE : $" + accountBalance;
        transactionHistory.add(transaction);
    }
    ...
    public boolean transfer(double amount, User recipient) 
    {
        if (amount <= accountBalance) 
        {
            ...
            transactionHistory.add("TRANSFER AMOUNT $" + amount + " TO " + recipient.getFirstName());
            return true;
        } 
        else 
        {
